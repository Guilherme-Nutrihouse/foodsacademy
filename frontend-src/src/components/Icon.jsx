const paths = {
  ...
  messageCircle: ["M21 11.5a8.4 8.4 0 0 1-9 8.4 8.5 8.5 0 0 1-4-.99L3 20l1.13-4.69A8.5 8.5 0 1 1 21 11.5z"],
  right: ["M9 5l7 7-7 7"],
...
const Icon = ({ name, className = "h-5 w-5", fill = "none", strokeWidth = 2 }) => (
  <svg
